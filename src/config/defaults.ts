...
export type ClockConfig = { version: 1; timezone: TimezoneId; locale: typeof LOCALES[number]; align: 'left' | 'center' | 'right'; gap: number; stroke: number; shadow: number; lines: [ClockLine, ClockLine] };
